...
class ViviendaServiceTest {
    ...
    void setup() {
        ...
        when(viviendaRepository.save(any(ViviendaEntity.class))).thenAnswer(invocation -> invocation.getArgument(0));
    }
    ...
    void crearVivienda_missingPropietario_throws() {
        ...
        assertThrows(IllegalArgumentException.class, () -> viviendaService.crearVivienda(v));
    ...
    void obtenerViviendaPorId_notFound_throws() {
        ...
        assertThrows(IllegalArgumentException.class, () -> viviendaService.obtenerViviendaPorId(5L));
    }
    ...
    void eliminarVivienda_notAvailable_throws() {
        ...
        assertThrows(IllegalStateException.class, () -> viviendaService.eliminarVivienda(4L));
