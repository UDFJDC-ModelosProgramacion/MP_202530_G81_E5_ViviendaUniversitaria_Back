...
public class PropietarioController {
    ...
    @PutMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public PropietarioDTO updatePropietario(@PathVariable("id") Long id, @RequestBody PropietarioDTO propietarioDTO) throws EntityNotFoundException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public List<ViviendaEntity> getViviendas(@PathVariable("propietarioId") Long propietarioId) throws EntityNotFoundException {
        return propietarioViviendaService.getViviendas(propietarioId);
    }

    @GetMapping("/{propietarioId}/viviendas/{viviendaId}")
    @ResponseStatus(HttpStatus.OK)
    public ViviendaEntity getVivienda(@PathVariable("propietarioId") Long propietarioId, @PathVariable("viviendaId") Long viviendaId) throws EntityNotFoundException, IllegalOperationException {
        return propietarioViviendaService.getVivienda(propietarioId, viviendaId);
    }

    @DeleteMapping("/{propietarioId}/viviendas/{viviendaId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void removeVivienda(@PathVariable("propietarioId") Long propietarioId, @PathVariable("viviendaId") Long viviendaId) throws EntityNotFoundException, IllegalOperationException {
